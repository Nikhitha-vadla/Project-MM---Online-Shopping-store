...
public class CartController {
	...
	public ResponseEntity<Cart> addingProductToCart(@PathVariable("cartId") Integer cartId,
	...
	public ResponseEntity<Cart> deleteByCartId(@PathVariable("cartId") Integer carrtId,
	...
	public ResponseEntity<Cart> updateQuantity(@PathVariable("cartId") Integer cartId, @PathVariable("pid") Integer pid,
